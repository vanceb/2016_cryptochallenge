python3 wordsolve.py -i WK3_CIPHERTEXT1.txt

harry,

if jamelia was working on a scheme to weaponise earthquakes, then we need to know how far she had got. i have sent trinity in to work undercover in jamelia’s lab and tasked her to try to infiltrate dynamiR from there. trinity isn’t too happy there, jamelia’s office isn’t much bigger than a broom closet, but we need to try to find the code base referred to in the hidden diary entry.
...
the big news for now is a breakthrough on the so called suicide note. given how small jamelia’s office was, trinity wondered why she had kept a broken printer in there neRt to the working one. trinity opened it up and found a few modifications which pointed the laser straight at the paper instead of the drum. she got in touch with the lab and got them to take another look at the letter. they found the attached message burned into the paper fibres. it is impossible to see with the naked eye, but the charring shows up under high powered fluoroscopy. over to you for the decryption.

{'Z': 'i', 'J': 'r', 'U': 'y', 'H': 'p', 'L': 't', 'X': 'g', 'B': 'k', 'Y': 'h', 'R': None, 'T': 'd', 'M': 'u', 'P': 'v', 'N': 'f', 'V': None, 'E': 'b', 'D': 'm', 'F': 'n', 'S': 'c', 'K': 's', 'I': 'q', 'O': 'e', 'W': 'a', 'Q': 'w', 'A': 'j', 'G': 'o', 'C': 'l'}
{'Z': 'i', 'J': 'r', 'U': 'y', 'H': 'p', 'L': 't', 'X': 'g', 'B': 'k', 'Y': 'h', 'R': 'abcdefghijklmnopqrstuvwxyz', 'T': 'd', 'M': 'u', 'P': 'v', 'N': 'f', 'V': 'abcdefghijklmnopqrstuvwxyz', 'E': 'b', 'D': 'm', 'F': 'n', 'S': 'c', 'K': 's', 'I': 'q', 'O': 'e', 'W': 'a', 'Q': 'w', 'A': 'j', 'G': 'o', 'C': 'l'}

## Need to manually solve R=x
